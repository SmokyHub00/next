...
const Hero = () => {
  ...
  return (
    <>
      <section className="w-full bg-white mt-0 md:mt-[120px]">
        <div className="max-w-7xl mx-auto px-4 pt-4 lg:pt-10 pb-6 flex flex-col items-center text-center font-['Helvetica_Now_Display']">
          ...
          {/* Main Headline (Mixed Nepali/English) */}
          <h1 className="text-[32px] md:text-[46px] font-medium leading-[1.3] tracking-normal mb-4 max-w-5xl" style={{ fontFamily: '"Helvetica Now Display", sans-serif' }}>
      ...
      {/* Video Section - Outside Gradient */}
      <div className="max-w-7xl mx-auto px-4 pb-6 flex flex-col items-center text-center font-['Helvetica_Now_Display']">
        {/* Video Placeholder */}
